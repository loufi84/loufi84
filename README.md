...
- <a href="https://https://github.com/Proser-V/portfolio-project" target="blank"><strong>L'atelier local:</a></strong> A web application to connect local artisans to possible clients with <a href="https://github.com/Proser-V">Valentin Dumont</a>
